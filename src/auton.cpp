...
void red_right() {
    ...
    // Move towards long goal and score
    chassis.moveToPoint(-42, -50, 2500, {.forwards=false}, false);
    openGate();
    chassis.turnToHeading(270, 500, {}, false);
    /*chassis.moveToPoint(-27, 51, 1100, {.forwards=false, .maxSpeed=80}, false);
    startTopScore();
...
void skills() {
    ...
    chassis.moveToPoint(38, -50, 1200, {}, false);
    chassis.turnToHeading(90, 600, {}, false);

    chassis.moveToPoint(24, -50, 1000, {.forwards=false, .maxSpeed=70}, false);
    startTopScore();
    pros::delay(1750);
    ...
    startIntake();
    openGate();
    chassis.moveToPoint(63, -50, 2000, {.maxSpeed=70}, false);
    pros::delay(1000);
    ...
    // Back off (#2)
    chassis.moveToPoint(47, -50, 800, {}, false);
    chassis.turnToHeading(0, 600, {}, false);
    stopTopScore();

    // Head towards top-right match loader
    chassis.moveToPoint(47, 20, 2500, {.minSpeed=60, .earlyExitRange=10}, false);
    chassis.moveToPoint(47, 42, 1500, {.maxSpeed=50}, false);
    chassis.turnToHeading(90, 700, {});
    startIntake();
    openGate();
    chassis.moveToPoint(65, 42, 2000, {.maxSpeed=70}, false);
    pros::delay(1000);
    ...
    chassis.moveToPose(15, 58, 270, 1500, {.lead=0.3, .minSpeed=55}, false);
    ...
    // Back off (#4)
    chassis.moveToPoint(-42, 46, 1000, {}, false);
    chassis.turnToHeading(180, 800, {}, false);
    stopTopScore();
